...
- Общий объём всего ответа — не более 260 слов (не считая предупреждений о качестве фото/уверенности). Это жёсткий лимит, пиши компактно и по существу, без повторов
"""
